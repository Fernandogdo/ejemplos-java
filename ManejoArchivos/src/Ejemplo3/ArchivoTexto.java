...
public class ArchivoTexto {
    ...
    public void abrir_archivo() {
        try {
            salida = new Formatter("calificaciones2.txt");
        } // fin de try
    ...
    public void agregar_informacion() {
        ...
        while (bandera) // itera hasta que bandera sea false
        {
            try // envía valores al archivo
            {
                ...
                System.out.println("Ingrese las calificaciones2:");
                double calificaciones2 = entrada.nextDouble();

                // escribe el nuevo registro (escribe en el archivo
                salida.format("%s|%s|%f|%f\n", nombre, apellido, calificaciones, calificaciones2);
